...
import * as __fd_glob_15 from "../content/docs/documentation/devops/docker-fundamentals.mdx?collection=documentation"
import * as __fd_glob_14 from "../content/docs/documentation/linux/advanced-bash-scripting.mdx?collection=documentation"
...
export const documentation = await create.docs("documentation", "content/docs/documentation", {"ai-ml/meta.json": __fd_glob_8, "devops/meta.json": __fd_glob_9, "linux/meta.json": __fd_glob_10, "sre/meta.json": __fd_glob_11, }, {"index.mdx": __fd_glob_12, "ai-ml/fastapi-ml-deployment.mdx": __fd_glob_13, "linux/advanced-bash-scripting.mdx": __fd_glob_14, "devops/docker-fundamentals.mdx": __fd_glob_15, "sre/kubernetes-monitoring.mdx": __fd_glob_16, });
