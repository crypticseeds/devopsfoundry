...
import { default as __fd_glob_10 } from "../content/docs/documentation/devops/meta.json?collection=documentation"
import { default as __fd_glob_9 } from "../content/docs/documentation/linux/meta.json?collection=documentation"
...
export const documentation = await create.docs("documentation", "content/docs/documentation", {"ai-ml/meta.json": __fd_glob_8, "linux/meta.json": __fd_glob_9, "devops/meta.json": __fd_glob_10, "sre/meta.json": __fd_glob_11, }, {"index.mdx": __fd_glob_12, "ai-ml/fastapi-ml-deployment.mdx": __fd_glob_13, "devops/docker-fundamentals.mdx": __fd_glob_14, "linux/advanced-bash-scripting.mdx": __fd_glob_15, "sre/kubernetes-monitoring.mdx": __fd_glob_16, });
