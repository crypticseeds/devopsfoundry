...
const browserCollections = {
  ...
  tutorials: create.doc("tutorials", {"index.mdx": () => import("../content/docs/tutorials/index.mdx?collection=tutorials"), "ai-ml/fastapi-ml-deployment.mdx": () => import("../content/docs/tutorials/ai-ml/fastapi-ml-deployment.mdx?collection=tutorials"), "devops/docker-fundamentals.mdx": () => import("../content/docs/tutorials/devops/docker-fundamentals.mdx?collection=tutorials"), "sre/kubernetes-monitoring.mdx": () => import("../content/docs/tutorials/sre/kubernetes-monitoring.mdx?collection=tutorials"), "linux/advanced-bash-scripting.mdx": () => import("../content/docs/tutorials/linux/advanced-bash-scripting.mdx?collection=tutorials"), }),
};
