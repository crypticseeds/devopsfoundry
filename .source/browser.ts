...
const browserCollections = {
  ...
  documentation: create.doc("documentation", {"index.mdx": () => import("../content/docs/documentation/index.mdx?collection=documentation"), "ai-ml/fastapi-ml-deployment.mdx": () => import("../content/docs/documentation/ai-ml/fastapi-ml-deployment.mdx?collection=documentation"), "devops/docker-fundamentals.mdx": () => import("../content/docs/documentation/devops/docker-fundamentals.mdx?collection=documentation"), "linux/advanced-bash-scripting.mdx": () => import("../content/docs/documentation/linux/advanced-bash-scripting.mdx?collection=documentation"), "sre/kubernetes-monitoring.mdx": () => import("../content/docs/documentation/sre/kubernetes-monitoring.mdx?collection=documentation"), }),
