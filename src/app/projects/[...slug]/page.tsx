            ...
            <DocsBody>
                <div className="container mx-auto max-w-4xl px-4 pt-0 pb-12">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                        {(tags.length > 0 ? tags : ['Kubernetes', 'Cloud Native', 'Microservices']).map((tag: string) => (
                            <span
                                key={tag}
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-sm text-secondary border-b border-secondary/20 pt-2 pb-4 mb-8">
