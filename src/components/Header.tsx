...
export function Header() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 mx-auto transition-all duration-300 ease-in-out ${
          isScrolled
            ? "top-4 w-[90%] md:w-[80%] max-w-5xl"
      ...
      >
        ...
        >
          ...
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <div
              className={`flex flex-col justify-center transition-all duration-300 ${isScrolled ? "scale-95 origin-left" : "scale-100"}`}
            >
