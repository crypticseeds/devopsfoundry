...
banner: /projects/tfl-journey-expense-calculator/banner.webp
---
...
- Repeating this process every month or every few months

![Manual Process](/projects/tfl-journey-expense-calculator/manual.png)

This app eliminates that hassle entirely. It's not just another CRUD app, it solves a real problem, built to demonstrate real-world AI application development with proper observability, security, and performance optimization.
...
![System Architecture](/projects/tfl-journey-expense-calculator/flow.svg)
...
![Upload Interface](/projects/tfl-journey-expense-calculator/upload-interface.png)

![Expense Summary](/projects/tfl-journey-expense-calculator/expense-summary.png)
...
![Langfuse Trace Before Optimization](/projects/tfl-journey-expense-calculator/langfuse-trace-1.png)
...
![Langfuse Trace After Optimization](/projects/tfl-journey-expense-calculator/langfuse-trace-2.png)
...
**GitHub Repository**: [tfl-journey-expense-calculator](https://github.com/crypticseeds/tfL-journey-expense-calculator.git)
